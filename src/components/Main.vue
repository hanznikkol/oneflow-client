<template>
    ...
    <div v-if="ticket.ticketID && ticket.status != 'Completed'" class="w-full min-h-svh flex justify-center m-auto lg:max-w-xl py-10 px-12 md:px-14 md:py-16 overflow-y-auto">
